                      ...
                      child: Padding(
                        ...
                        child: StreamBuilder<List<CompletedRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<CompletedRecord> columnCompletedRecordList =
                                snapshot.data;
                            if (columnCompletedRecordList.isEmpty) {
                              return Center(
                                child: Image.asset(
                            ...
                            return SingleChildScrollView(
                              child: Column(
                                ...
                                children: List.generate(
                                    columnCompletedRecordList.length,
                                    (columnIndex) {
                                  final columnCompletedRecord =
                                      columnCompletedRecordList[columnIndex];
                                  return Padding(
